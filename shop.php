        ...
        <div class="row mt-5">
            <div class="col-lg-4 border-side">
                            ...
                            <div class="range_slider">
                                <div class="wrapper">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="range" min="0" max="100" value="28" id="slider-1"
                                            oninput="slideOne()">
                                        <input type="range" min="0" max="100" value="75" id="slider-2"
                                            oninput="slideTwo()">
                                    </div>
                                </div>
                                <div class="values">
                ...
                <div class="col-lg-8">
                        ...
                        <div class="col-lg-4">
                            <div class="product-sec product-one">
                                ...
                                <div>
                                    ...
                                    <p class="product_name">Continuité gentilice et continuité familiale dans les
                                        familles
                        ...
                        <div class="col-lg-4">
                            <div class="product-sec product-one">
                                ...
                                <div>
                                    ...
                                    <p class="product_name">Kings, Chronologies and Genealogies: Studies in the
                                        Political
                        ...
                        <div class="col-lg-4">
                            <div class="product-sec ">
                                ...
                                <div>
                                    ...
                                    <p class="product_name">Ou sont les femmes? Prosopographie des femmes des familles
                                        princières et ducales en Italie méridionale 774-1100</p>
                                </div>
                    ...
                    <nav aria-label="Page navigation example" class="page-change">
                        <ul class="pagination justify-content-center">
                            <li class="page-item active change">
                                <a class="page-link pg-change" href="#">1 <span class="sr-only">(current)</span></a>
                            </li>
