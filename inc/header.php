    ...
    <div class="web-nav">
        ...
        <div class="container-fluid ">
            <div class="row">
                ...
                <div class="col-10 d-flex header-icon-wrapper justify-content-center">
                    <div class="nav-web">
                        <ul>
                            <li>
...
<header id="header">
    <div class="mobile-header navbar-dark">
        ...
        <ul class="mobile-nav navbar-nav">
            ...
            <li class="nav-link"><a class="text-black" href="about.php"> About</a></li>
            <li class="nav-link"><a class="text-black" href="pricing.php">Pricing</a></li>
            <li class="nav-link"><a class="text-black" href="shop.php"> shop</a></li>
            <li class="nav-link"><a class="text-black" href="publications.php">Publications</a></li>
            <li class="nav-link"><a class="text-black" href="blog.php">blog</a></li>
            <li class="nav-link"><a class="text-black" href="database.php"> Database</a></li>
    ...
    <div class="mobile-headers  navbar-dark" id="bargi">
        ...
        <div class="cart_box">
            <div class="for_item">
                ...
                <div class="text">
                    <p>Comtes, Vicomtes et noblesse au Nord de l'Aquitaine aux Xe - XIesiécles: Etudes
                        prosopographiques, historiques et constitutionnelles sure le Poitou, l'Aunis et la Saintonge</p>
                    <div class="price_etc">
                        <p>1 × £30.00</p>
