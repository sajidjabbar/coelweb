...
<section class="cookie-policy-sec">
    <div class="container">
        ...
        <div class="info">
            ...
            <div class="info">
                <p>Ioannis Saresberiensis Metalogicon, ed. J.B.Hall et K.S.B.Keats-Rohan, Corpus Christianorum Continuatio Mediaeualis xcviii, 1991.</p>
            </div>
            <div class="info">
                <p>Ioannis Saresberiensis Policraticus Libri I-IV,<a href="">CCSM</a>  cxviii, 1993.</p>
                <p>'The chronology of John of Salisbury's studies in Paris ', Studi Medievali, 3 ser. 28 (1987), 193-203.</p>
                <p>'John of Salisbury and twelfth-century education in Paris ', History of Universities, vi (1986), 1-45.</p>
            ...
            <div class="info">
                <h4>Prosopography</h4>
                <span><a href="http://www.coelweb.co.uk/NamesIdentity.pdf">'Biography, Names and Identity; </a> Understanding the pursuit of the individual in prosopography', in
                    <a href="">Prosopography Approaches and Applications</a>(Prosop. et Gen. 13, 2007).</span>
            </div>
            <div class="info">
                <p>‘Prosopography and Computers: a marriage made in heaven?', History and Computing 10.1 (2000), ed. M. Wollard and K.S.B. Keats-Rohan.</p>
                <span>'Progress or Perversion? Current issues in prosopography' (2003) <a href="http://www.coelweb.co.uk/progress-or-perversion.pdf"> progress-or-perversion.pdf</a></span>
            </div>
            <div class="info this">
            ...
            <div class="info">
                ...
                <p>'COEL and the Computer: Towards a prosopographical key to Anglo-Norman documents 1066-1166', written jointly with D.E. 
                    ...
                    <span><a href="http://www.coelweb.co.uk/FamFIEF.pdf"> 'Domesday Book and the Malets: </a>Patrimony and the private histories of public lives',   Nottingham Medieval Studies xli (1997) 13-56.</span>
                    <span>'Belvoir: The heirs of Robert and Berenger de Tosny',<a href="">Prosopon</a>9, July 1998.</span>
                ...
                <p>'Two studies in North French Prosopography 1) Ivo fitz Fulcoin, the Counts of Maine, the lords of Bellême and the foundation of L'Abbayette c.996 2) Wigan the Marshal, alias Guigan Algason and Other Bretons 
                    ...
                    <p>'Les Bilihildis du Maine: Problèmes et possibilités d'une étude de l'onomastique et de la parenté de la France du nord-ouest', Onomastique et parenté I: actes de la table-ronde de Saint-
                        ...
                        <p>'Observations upon the earliest castellanies in Maine', in Mondes de l'Ouest et villes du Monde.
                            ...
                            Institut historique allemand à Paris 8-9 novembre 1996, ed. C. Settipani and K.S.B. Keats-Rohan (P&G, Oxford , 2000).</p>
                            <p>‘Poppa of Bayeux and her family’, The American Genealogist, vol 72  (1987), 187-204.</p>
                            <p>'Francs, scandinaves or normands? Aperçus sur les premiers moines des monastères normands',  in Les Fondations scandinaves et les débuts du duché de
                                 Normandie: Colloque de Cerisy-la-Salle (septembre 2002), ed. Pierre Bauduin (Caen , 2005), 195-208.</p>
            </div>
            <div class="info ">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-secondary close" data-dismiss="modal">Close <i class="fa fa-times" aria-hidden="true"></i></button>
      </div>
      </div>
    </div>
  </div>
</div>
            <span class="block-this">The Cartulary of the Abbey of Mont-Saint-Michel (Donington, 2006) [available from the publisher Shaun Tyas, by writing to
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-secondary close" data-dismiss="modal">Close <i class="fa fa-times" aria-hidden="true"></i></button>
             ...
             <span class="block-this">'The devolution of the Honor of Wallingford 1066-1154', Oxoniensia,
                 ...
                 <p>'The making of Henry of Oxford: Englishmen in a Norman World', ibid., 287-310 (some details corrected in Domesday People above).</p>
            </div>
