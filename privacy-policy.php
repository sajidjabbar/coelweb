...
<section class="page-info-sec-policy">
    <div class="container">
        <div class="page-info">
            <h3>Who We Are</h3>
            <div class="info">
                <span> <span class="text-bold">Suggested text:</span> Our website address is: <a
                        href="">https://cyber-demo-client-websites.com/book-upr/</a></span>
            </div>
            <div class="info">
                <h4>Comments</h4>
                <span><span class="text-bold">Suggested text:</span>When visitors leave comments on the site we collect
            ...
            <div class="info">
                <h4>Media</h4>
                <span><span class="text-bold">Suggested text:</span> If you upload images to the website, you should
                    avoid
                    uploading images with embedded location data (EXIF GPS) included.
                    Visitors to the website can download and extract any location data from images on the
                    website.</span>
            </div>
            <div class="info">
                <h4>Cookies</h4>
                <span><span class="text-bold">Suggested text:</span>If you leave a comment on our site you may opt-in
                    to saving your name, email address and website in cookies. These are for your convenience so that
                    you do not
                    have to fill in your details again when you leave another comment. These cookies will last for one
                    year.</span>
            </div>
            <div class="info">
            ...
            <div class="info">
                ...
                <span> <span class="text-bold">Suggested text:</span> Articles on this site may include embedded content
            ...
            <div class="info">
                <p>These websites may collect data about you, use cookies, embed additional third-party tracking, and
                    ...
                    including tracking your interaction with the embedded content if you have an account and are logged
                    in to that
                    website</p>
            </div>
            <div class="info">
                <h4>Who we share your data with</h4>
                <span> <span class="text-bold">Suggested text:</span> If you request a password reset, your IP address
                    will be included in the reset email.</span>
            </div>
            <div class="info">
                <h4>How long we retain your data</h4>
                <span> <span class="text-bold">Suggested text:</span> If you leave a comment, the comment and its
                    metadata are
            ...
            <div class="info">
                <p>For users that register on our website (if any), we also store the personal information they provide
                    ...
                    at any time (except they cannot change their username). Website administrators can also see and edit
                    that
                    information.</p>
            </div>
            <div class="info">
                ...
                <span> <span class="text-bold">Suggested text:</span> If you have an account on this site, or have left
                    comments, you can request to receive an exported file of the personal data we hold about you,
                    including any
                    data you have provided to us. You can also request that we erase any personal data we
                    hold about you. This does not include any data we are obliged to keep for administrative, legal, or
                    security
                    purposes.</span>
            </div>
            <div class="info">
                <h4>Where we send your data</h4>
                <span> <span class="text-bold">Suggested text:</span>Visitor comments may be checked through an
                    automated spam detection service.</span>
            </div>
        </div>
    </div>
</section>
